...
import { View, Text, Image, StyleSheet, SafeAreaView, ScrollView, Pressable, Dimensions } from 'react-native';
...
export default function PreviewScreen() {
  ...
  const reload = useCallback(async () => {
    const [c, p, trial] = await Promise.all([loadCycleSettings(), loadPhotoMeta(), getTrialStatus()]);
    setCycle(c);
    setPhotoMeta(p);
          ...
          <View style={styles.phoneShell}>
            <View style={styles.phoneScreen}>
              {photo?.uri ? (
                ...
                <View style={[StyleSheet.absoluteFill, { backgroundColor: info.soft }]}>{content}</View>
              )}
